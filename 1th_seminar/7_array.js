...
console.log(countries.sort( (a, b) => a > b ? 1 : -1) ); // Andorra, Vietnam, osterreich (제대로 정렬이 되지 않았습니다.)
console.log(countries.sort( function(a, b) { return a.localeCompare(b); })); // Andorra,osterreich,Vietnam (제대로 정렬되었네요!) 유니코드 기준으로 문자 정렬
//@ a.localeCompare(b) : 
